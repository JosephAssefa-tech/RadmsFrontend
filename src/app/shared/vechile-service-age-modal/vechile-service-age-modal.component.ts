...
import { VechileService } from 'src/app/services/vechile/vechile.service';
import { VehicleServiceAgeService } from 'src/app/services/vehicle-service-age/vehicle-service-age.service';

@Component({
  selector: 'app-vechile-service-age-modal',
  templateUrl: './vechile-service-age-modal.component.html',
  styleUrls: ['./vechile-service-age-modal.component.scss']
})
export class VechileServiceAgeModalComponent implements OnInit {
  ...
  constructor(
    ...
    private regionService: VehicleServiceAgeService
  ) {}

  ngOnInit(): void {
  this.setButtonLable();
    this.validateForm = this.fb.group({
      vehicleServiceName: ['', Validators.required],
      vehicleServiceNameAm:[''],
      vehicleServiceNameOr:[''],
      vehicleServiceNameSo:[''],
      vehicleServiceNameTi:[''],
      vehicleServiceNameAf:['']
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        vehicleServiceName: rowData.vehicleServiceName,
        vehicleServiceNamem:rowData.vehicleServiceNameAm,
        vehicleServiceNameOr:rowData.vehicleServiceNameOr,
        vehicleServiceNameSo:rowData.vehicleServiceNameSo,
        vehicleServiceNameTi:rowData.vehicleServiceNameTi,
        vehicleServiceNameAf:rowData.vehicleServiceNameAf,
