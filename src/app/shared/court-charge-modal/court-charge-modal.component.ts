...
@Component({
  selector: 'app-court-charge-modal',
  templateUrl: './court-charge-modal.component.html',
  styleUrls: ['./court-charge-modal.component.scss']
})
export class CourtChargeModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: CourtChargeServiceService
  ) { }

  ngOnInit(): void {
    this.setButtonLable();
    this.validateForm = this.fb.group({
      CourtChargeType: ['', Validators.required],
      CourtChargeTypeAm:[''],
      CourtChargeTypeOr:[''],
      CourtChargeTypeTi:[''],
      CourtChargeTypeAf:[''],
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        CourtChargeType: rowData.CourtChargeType,
        CourtChargeTypeAm:rowData.CourtChargeTypeAm,
        CourtChargeTypeOr:rowData.CourtChargeTypeOr,
        CourtChargeTypeTi:rowData.CourtChargeTypeTi,
        CourtChargeTypeAf:rowData.CourtChargeTypeAf,
        CourtChargeTypeSo:rowData.CourtChargeTypeSo,
  ...
  setButtonLable()
{
  this.sharedbuttonService.getButtonLabel().subscribe((label: string) => {
    if (this.action === 'Edit') {
      ...
      this.buttonLabel = 'Update court charge type '; // Customize the label for editing
      this.onUpdate();
