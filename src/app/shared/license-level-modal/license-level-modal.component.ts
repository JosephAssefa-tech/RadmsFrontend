...
@Component({
  selector: 'app-license-level-modal',
  templateUrl: './license-level-modal.component.html',
  styleUrls: ['./license-level-modal.component.scss']
})
export class LicenseLevelModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: LicenseLevelService
  ) { }

  ngOnInit(): void {
    this.setButtonLable();
    this.validateForm = this.fb.group({
      leveloflicenceName: ['', Validators.required],
      leveloflicenceNameAm:[''],
      leveloflicenceNameOr:[''],
      leveloflicenceNameTi:[''],
      leveloflicenceNameAf:[''],
      leveloflicenceNameSo:['']
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        leveloflicenceName: rowData.leveloflicenceName,
        leveloflicenceNameAm:rowData.leveloflicenceNameAm,
        leveloflicenceNameOr:rowData.leveloflicenceNameOr,
        leveloflicenceNameTi:rowData.leveloflicenceNameTi,
        leveloflicenceNameAf:rowData.leveloflicenceNameAf,
        leveloflicenceNameSo:rowData.leveloflicenceNameSo,
