...
@Component({
  selector: 'app-accident-type-modal',
  templateUrl:'./accident-type-modal.component.html',
  styleUrls: ['./accident-type-modal.component.scss']
})
export class AccidentTypeModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: AccidentTypeService
  ) { }
  ...
  ngOnInit(): void {
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        AccidentType: rowData.AccidentType,
        AccidentTypeAm:rowData.AccidentTypeAm,
        AccidentTypeOr:rowData.AccidentTypeOr,
        AccidentTypeTi:rowData.AccidentTypeTi,
        AccidentTypeAf:rowData.AccidentTypeAf,
        AccidentTypeSo:rowData.AccidentTypeSo,
