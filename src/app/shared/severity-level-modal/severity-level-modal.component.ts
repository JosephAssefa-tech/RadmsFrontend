...
@Component({
  selector: 'app-severity-level-modal',
  templateUrl: './severity-level-modal.component.html',
  styleUrls: ['./severity-level-modal.component.scss']
})
export class SeverityLevelModalComponent implements OnInit{
  ...
  constructor(
    ...
    private healthService: SeverityLevelService
  ) { }
  ...
  ngOnInit(): void {
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        SeverityType: rowData.SeverityType,
        SeverityTypeAm:rowData.SeverityTypeAm,
        SeverityTypeOr:rowData.SeverityTypeOr,
        SeverityTypeTi:rowData.SeverityTypeTi,
        SeverityTypeAf:rowData.SeverityTypeAf,
        SeverityTypeSo:rowData.SeverityTypeSo,
