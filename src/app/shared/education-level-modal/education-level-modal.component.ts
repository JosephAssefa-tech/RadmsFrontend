...
@Component({
  selector: 'app-education-level-modal',
  templateUrl: './education-level-modal.component.html',
  styleUrls: ['./education-level-modal.component.scss']
})
export class EducationLevelModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: EducationLevelService
  ) { }

  ngOnInit(): void {
    this.setButtonLable();
    this.validateForm = this.fb.group({
      educationLevelName: ['', Validators.required],
      educationLevelNameAm:[''],
      educationLevelNameOr:[''],
      educationLevelNameTi:[''],
      educationLevelNameAf:[''],
      educationLevelNameSo:['']
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        educationLevelName: rowData.educationLevelName,
        educationLevelNameAm:rowData.educationLevelNameAm,
        educationLevelNameOr:rowData.educationLevelNameOr,
        educationLevelNameTi:rowData.educationLevelNameTi,
        educationLevelNameAf:rowData.educationLevelNameAf,
        educationLevelNameSo:rowData.educationLevelNameSo,
