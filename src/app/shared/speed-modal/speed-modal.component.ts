...
@Component({
  ...
  styleUrls: ['./speed-modal.component.scss']
})
export class SpeedModalComponent implements OnInit {
  ...
  constructor(
    ...
    private regionService: SpeedLimitService
  ) {}

  ngOnInit(): void {
  this.setButtonLable();
    this.validateForm = this.fb.group({
      speedLimitName: ['', Validators.required],
      speedLimitNameAm:[''],
      speedLimitNameOr:[''],
      speedLimitNameSo:[''],
      speedLimitNameTi:[''],
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        speedLimitName: rowData.speedLimitName,
        speedLimitNameAm:rowData.speedLimitNameAm,
        speedLimitNameOr:rowData.speedLimitNameOr,
        speedLimitNameSo:rowData.speedLimitNameSo,
        speedLimitNameTi:rowData.speedLimitNameTi,
        speedLimitNameAf:rowData.speedLimitNameAf,
