...
@Component({
  selector: 'app-highway-type-modal',
  templateUrl: './highway-type-modal.component.html',
  styleUrls: ['./highway-type-modal.component.scss']
})
export class HighwayTypeModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: HighwayTypeService
  ) { }

  ngOnInit(): void {
    this.setButtonLable();
    this.validateForm = this.fb.group({
      htypeName: ['', Validators.required],
      htypeNameAm:[''],
      htypeNameOr:[''],
      htypeNameTi:[''],
      htypeNameAf:[''],
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        htypeName: rowData.htypeName,
        htypeNameAm:rowData.htypeNameAm,
        htypeNameOr:rowData.htypeNameOr,
        htypeNameTi:rowData.htypeNameTi,
        htypeNameAf:rowData.htypeNameAf,
        htypeNameSo:rowData.htypeNameSo,
