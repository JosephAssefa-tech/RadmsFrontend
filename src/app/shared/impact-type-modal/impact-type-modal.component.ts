...
@Component({
  selector: 'app-impact-type-modal',
  templateUrl: './impact-type-modal.component.html',
  styleUrls: ['./impact-type-modal.component.scss']
})
export class ImpactTypeModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: ImpactTypeService
  ) { }

  ngOnInit(): void {
    this.setButtonLable();
    this.validateForm = this.fb.group({
      impactTypeName: ['', Validators.required],
      impactTypeNameAm:[''],
      impactTypeNameOr:[''],
      impactTypeNameTi:[''],
      impactTypeNameAf:[''],
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        ...
        impactTypeNameAm:rowData.impactTypeNameAm,
        impactTypeNameOr:rowData.impactTypeNameOr,
        impactTypeNameTi:rowData.impactTypeNameTi,
        impactTypeNameAf:rowData.impactTypeNameAf,
        impactTypeNameSo:rowData.impactTypeNameSo,
