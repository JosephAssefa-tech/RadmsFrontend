...
@Component({
  selector: 'app-collision-type-modal',
  templateUrl: './collision-type-modal.component.html',
  styleUrls: ['./collision-type-modal.component.scss']
})
export class CollisionTypeModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: CollisionTypeService
  ) { }

  ngOnInit(): void {
    this.setButtonLable();
    this.validateForm = this.fb.group({
      collisionTypeName: ['', Validators.required],
      collisionTypeNameAm:[''],
      collisionTypeNameOr:[''],
      collisionTypeNameTi:[''],
      collisionTypeNameAf:[''],
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        collisionTypeName: rowData.collisionTypeName,
        collisionTypeNameAm:rowData.collisionTypeNameAm,
        collisionTypeNameOr:rowData.collisionTypeNameOr,
        collisionTypeNameTi:rowData.collisionTypeNameTi,
        collisionTypeNameAf:rowData.collisionTypeNameAf,
        collisionTypeNameSo:rowData.collisionTypeNameSo,
