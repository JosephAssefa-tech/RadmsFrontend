...
@Component({
  selector: 'app-vechile-defect-modal',
  templateUrl: './vechile-defect-modal.component.html',
  styleUrls: ['./vechile-defect-modal.component.scss']
})
export class VechileDefectModalComponent implements OnInit {
  ...
  constructor(
    ...
    private regionService: VechileDefectsService
  ) {}

  ngOnInit(): void {
  this.setButtonLable();
    this.validateForm = this.fb.group({
      vehicleDefectName: ['', Validators.required],
      vehicleDefectNameAm:[''],
      vehicleDefectNameOr:[''],
      vehicleDefectNameSo:[''],
      vehicleDefectNameTi:[''],
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        vehicleDefectName: rowData.vehicleDefectName,
        vehicleDefectNameAm:rowData.vehicleDefectNameAm,
        vehicleDefectNameOr:rowData.vehicleDefectNameOr,
        vehicleDefectNameSo:rowData.vehicleDefectNameSo,
        vehicleDefectNameTi:rowData.vehicleDefectNameTi,
        vehicleDefectNameAf:rowData.vehicleDefectNameAf,
