...
@Component({
  selector: 'app-roadcaarriageway-type-modal',
  templateUrl: './roadcaarriageway-type-modal.component.html',
  styleUrls: ['./roadcaarriageway-type-modal.component.scss']
})
export class RoadcaarriagewayTypeModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: RoadCarriagewayService
  ) { }

  ngOnInit(): void {
    this.setButtonLable();
    this.validateForm = this.fb.group({
      roadCarriagewayName: ['', Validators.required],
      roadCarriagewayNameAm:[''],
      roadCarriagewayNameOr:[''],
      roadCarriagewayNameTi:[''],
      roadCarriagewayNameAf:[''],
      roadCarriagewayNameSo:['']
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        roadCarriagewayName: rowData.roadCarriagewayName,
        roadCarriagewayNameAm:rowData.roadCarriagewayNameAm,
        roadCarriagewayNameOr:rowData.roadCarriagewayNameOr,
        roadCarriagewayNameTi:rowData.roadCarriagewayNameTi,
        roadCarriagewayNameAf:rowData.roadCarriagewayNameAf,
        roadCarriagewayNameSo:rowData.roadCarriagewayNameSo,
