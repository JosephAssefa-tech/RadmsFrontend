...
@Component({
  selector: 'app-terian-type-modal',
  templateUrl: './terian-type-modal.component.html',
  styleUrls: ['./terian-type-modal.component.scss']
})
export class TerianTypeModalComponent implements OnInit {
...
constructor(
  ...
  private healthService: TerrianTypeService
) { }

ngOnInit(): void {
  this.setButtonLable();
  this.validateForm = this.fb.group({
    TerrianName: ['', Validators.required],
    TerrianNameAm:[''],
    TerrianNameOr:[''],
    TerrianNameTi:[''],
    TerrianNameAf:[''],
  ...
  .subscribe((rowData: any) => {
    ...
    this.validateForm.patchValue({
      TerrianName: rowData.TerrianName,
      TerrianNameAm:rowData.TerrianNameAm,
      TerrianNameOr:rowData.TerrianNameOr,
      TerrianNameTi:rowData.TerrianNameTi,
      TerrianNameAf:rowData.TerrianNameAf,
      TerrianNameSo:rowData.TerrianNameSo,
