...
@Component({
  selector: 'app-vechile-owner-modal',
  templateUrl: './vechile-owner-modal.component.html',
  styleUrls: ['./vechile-owner-modal.component.scss']
})
export class VechileOwnerModalComponent implements OnInit {
  ...
  constructor(
    ...
    private regionService:VechileOwnerService
  ) {}
  ...
  this.setButtonLable();
    this.validateForm = this.fb.group({
      ...
      vehicleOwnershipNameAm:[''],
      vehicleOwnershipNameOr:[''],
      vehicleOwnershipNameSo:[''],
      vehicleOwnershipNameTi:[''],
      vehicleOwnershipNameAf:['']
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        vehicleOwnershipName: rowData.vehicleOwnershipName,
        vehicleOwnershipNameAm:rowData.vehicleOwnershipNameAm,
        vehicleOwnershipNameOr:rowData.vehicleOwnershipNameOr,
        vehicleOwnershipNameSo:rowData.vehicleOwnershipNameSo,
        vehicleOwnershipNameTi:rowData.vehicleOwnershipNameTi,
        vehicleOwnershipNameAf:rowData.vehicleOwnershipNameAf,
...
setButtonLable()
{
  this.sharedbuttonService.getButtonLabel().subscribe((label: string) => {
    if (this.action === 'Edit') {
      ...
      this.buttonLabel = 'Update vechile ownder condition'; // Customize the label for editing
      this.onUpdate();
