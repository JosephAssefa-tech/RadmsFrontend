...
@Component({
  selector: 'app-weather-condition-modal',
  templateUrl: './weather-condition-modal.component.html',
  styleUrls: ['./weather-condition-modal.component.scss']
})
export class WeatherConditionModalComponent implements OnInit {
  ...
  constructor(
    ...
    private regionService: WeatherConditionService
  ) {}

  ngOnInit(): void {
  this.setButtonLable();
    this.validateForm = this.fb.group({
      weatherCondName: ['', Validators.required],
      weatherCondNameAm:[''],
      weatherCondNameOr:[''],
      weatherCondNameSo:[''],
      weatherCondNameTi:[''],
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        weatherCondName: rowData.weatherCondName,
        weatherCondNameAm:rowData.weatherCondNameAm,
        weatherCondNameOr:rowData.weatherCondNameOr,
        weatherCondNameSo:rowData.weatherCondNameSo,
        weatherCondNameTi:rowData.weatherCondNameTi,
        weatherCondNameAf:rowData.weatherCondNameAf,
