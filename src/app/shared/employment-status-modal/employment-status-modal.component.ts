...
@Component({
  selector: 'app-employment-status-modal',
  templateUrl: './employment-status-modal.component.html',
  styleUrls: ['./employment-status-modal.component.scss']
})
export class EmploymentStatusModalComponent implements OnInit{
  ...
  constructor(
    ...
    private healthService: EmployementStatusService
  ) { }
  ...
  ngOnInit(): void {
    ...
    this.validateForm = this.fb.group({
      ...
      employmentStatusNameAm:[''],
      employmentStatusNameOr:[''],
      employmentStatusNameTi:[''],
      employmentStatusNameAf:[''],
      employmentStatusNameSo:['']
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        ...
        employmentStatusNameAm:rowData.employmentStatusNameAm,
        employmentStatusNameOr:rowData.employmentStatusNameOr,
        employmentStatusNameTi:rowData.employmentStatusNameTi,
        employmentStatusNameAf:rowData.employmentStatusNameAf,
        employmentStatusNameSo:rowData.employmentStatusNameSo,
  ...
  setButtonLable()
{
  this.sharedbuttonService.getButtonLabel().subscribe((label: string) => {
    if (this.action === 'Edit') {
      ...
      this.buttonLabel = 'Update employment status'; // Customize the label for editing
      this.onUpdate();
