...
@Component({
  selector: 'app-junction-type-modal',
  templateUrl: './junction-type-modal.component.html',
  styleUrls: ['./junction-type-modal.component.scss']
})
export class JunctionTypeModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: JunctionTypeService
  ) { }

  ngOnInit(): void {
    this.setButtonLable();
    this.validateForm = this.fb.group({
      junctionTypeName: ['', Validators.required],
      junctionTypeNameAm:[''],
      junctionTypeNameOr:[''],
      junctionTypeNameTi:[''],
      junctionTypeNameAf:[''],
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        junctionTypeName: rowData.junctionTypeName,
        junctionTypeNameAm:rowData.junctionTypeNameAm,
        junctionTypeNameOr:rowData.junctionTypeNameOr,
        junctionTypeNameTi:rowData.junctionTypeNameTi,
        junctionTypeNameAf:rowData.junctionTypeNameAf,
        junctionTypeNameSo:rowData.junctionTypeNameSo,
