...
export class CourtChargeServiceService extends BaseService<CourtChargeType> {
  private buttonLabelSubject: BehaviorSubject<string> = new BehaviorSubject<string>('');
  listOfVechiles=`${environment.apiUrl}CourtChargeType`;
  ...
  // }
  addRegion(vechile: CourtChargeType): Observable<any> {
