...
@Component({
  selector: 'app-accident-casuse-modal',
  templateUrl: './accident-casuse-modal.component.html',
  styleUrls: ['./accident-casuse-modal.component.scss']
})
export class AccidentCasuseModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: AccidentDetailServiceService
  ) { }

  ngOnInit(): void {
    this.setButtonLable();
    this.validateForm = this.fb.group({
      accidentCauseName: ['', Validators.required],
      accidentCauseNameAm:[''],
      accidentCauseNameOr:[''],
      accidentCauseNameTi:[''],
      accidentCauseNameAf:[''],
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        accidentCauseName: rowData.accidentCauseName,
        accidentCauseNameAm:rowData.accidentCauseNameAm,
        accidentCauseNameOr:rowData.accidentCauseNameOr,
        accidentCauseNameTi:rowData.accidentCauseNameTi,
        accidentCauseNameAf:rowData.accidentCauseNameAf,
        accidentCauseNameSo:rowData.accidentCauseNameSo,
