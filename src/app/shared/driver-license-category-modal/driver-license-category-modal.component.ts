...
@Component({
  selector: 'app-driver-license-category-modal',
  templateUrl: './driver-license-category-modal.component.html',
  styleUrls: ['./driver-license-category-modal.component.scss']
})
export class DriverLicenseCategoryModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: DrivingLicenceCategoriesService
  ) { }

  ngOnInit(): void {
    this.setButtonLable();
    this.validateForm = this.fb.group({
      drivingLicenceCatagoryName: ['', Validators.required],
      drivingLicenceCatagoryNameAm:[''],
      drivingLicenceCatagoryNameOr:[''],
      drivingLicenceCatagoryNameTi:[''],
      drivingLicenceCatagoryNameAf:[''],
      drivingLicenceCatagoryNameSo:['']
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        drivingLicenceCatagoryName: rowData.drivingLicenceCatagoryName,
        drivingLicenceCatagoryNameAm:rowData.drivingLicenceCatagoryNameAm,
        drivingLicenceCatagoryNameOr:rowData.drivingLicenceCatagoryNameOr,
        drivingLicenceCatagoryNameTi:rowData.drivingLicenceCatagoryNameTi,
        drivingLicenceCatagoryNameAf:rowData.drivingLicenceCatagoryNameAf,
        drivingLicenceCatagoryNameSo:rowData.drivingLicenceCatagoryNameSo,
  ...
  setButtonLable()
{
  this.sharedbuttonService.getButtonLabel().subscribe((label: string) => {
    if (this.action === 'Edit') {
      ...
      this.buttonLabel = 'Update driving licence category'; // Customize the label for editing
      this.onUpdate();
