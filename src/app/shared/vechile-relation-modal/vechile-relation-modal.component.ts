...
@Component({
  selector: 'app-vechile-relation-modal',
  templateUrl: './vechile-relation-modal.component.html',
  styleUrls: ['./vechile-relation-modal.component.scss']
})
export class VechileRelationModalComponent implements OnInit {
  ...
  constructor(
    ...
    private regionService: VechileRelationService
  ) {}

  ngOnInit(): void {
  this.setButtonLable();
    this.validateForm = this.fb.group({
      vehicleRelationName: ['', Validators.required],
      vehicleRelationNameAm:[''],
      vehicleRelationNameOr:[''],
      vehicleRelationNameSo:[''],
      vehicleRelationNameTi:[''],
      vehicleRelationNameAf:['']
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        vehicleRelationName: rowData.vehicleRelationName,
        vehicleRelationNameAm:rowData.vehicleRelationNameAm,
        vehicleRelationNameOr:rowData.vehicleRelationNameOr,
        vehicleRelationNameSo:rowData.vehicleRelationNameSo,
        vehicleRelationNameTi:rowData.vehicleRelationNameTi,
        vehicleRelationNameAf:rowData.vehicleRelationNameAf,
