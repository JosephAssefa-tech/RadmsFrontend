...
@Component({
  selector: 'app-victim-movement-modal',
  templateUrl: './victim-movement-modal.component.html',
  styleUrls: ['./victim-movement-modal.component.scss']
})
export class VictimMovementModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: VictimMovementService
  ) { }

  ngOnInit(): void {
    this.setButtonLable();
    this.validateForm = this.fb.group({
      victimMovementType: ['', Validators.required],
      victimMovementTypeAm:[''],
      victimMovementTypeOr:[''],
      victimMovementTypeTi:[''],
      victimMovementTypeAf:[''],
      victimMovementTypeSo:['']
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        victimMovementType: rowData.victimMovementType,
        victimMovementTypeAm:rowData.victimMovementTypeAm,
        victimMovementTypeOr:rowData.victimMovementTypeOr,
        victimMovementTypeTi:rowData.victimMovementTypeTi,
        victimMovementTypeAf:rowData.victimMovementTypeAf,
        victimMovementTypeSo:rowData.victimMovementTypeSo,
