...
@Component({
  selector: 'app-driver-experience-modal',
  templateUrl: './driver-experience-modal.component.html',
  styleUrls: ['./driver-experience-modal.component.scss']
})
export class DriverExperienceModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: DriverExperienceService
  ) { }

  ngOnInit(): void {
    this.setButtonLable();
    this.validateForm = this.fb.group({
      driverExperienceName: ['', Validators.required],
      driverExperienceNameAm:[''],
      driverExperienceNameOr:[''],
      driverExperienceNameTi:[''],
      driverExperienceNameAf:[''],
      driverExperienceNameSo:['']
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        driverExperienceName: rowData.driverExperienceName,
        driverExperienceNameAm:rowData.driverExperienceNameAm,
        driverExperienceNameOr:rowData.driverExperienceNameOr,
        driverExperienceNameTi:rowData.driverExperienceNameTi,
        driverExperienceNameAf:rowData.driverExperienceNameAf,
        driverExperienceNameSo:rowData.driverExperienceNameSo,
  ...
  setButtonLable()
{
  this.sharedbuttonService.getButtonLabel().subscribe((label: string) => {
    if (this.action === 'Edit') {
      ...
      this.buttonLabel = 'Update Experience'; // Customize the label for editing
      this.onUpdate();
