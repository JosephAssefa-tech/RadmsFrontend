...
@Component({
  selector: 'app-pavement-type-modal',
  templateUrl: './pavement-type-modal.component.html',
  styleUrls: ['./pavement-type-modal.component.scss']
})
export class PavementTypeModalComponent implements OnInit {
  ...
  constructor(
    ...
    private healthService: PavementTypeService
  ) { }

  ngOnInit(): void {
    this.setButtonLable();
    this.validateForm = this.fb.group({
      pavementName: ['', Validators.required],
      pavementNameAm:[''],
      pavementNameOr:[''],
      pavementNameTi:[''],
      pavementNameAf:[''],
    ...
    .subscribe((rowData: any) => {
      ...
      this.validateForm.patchValue({
        pavementName: rowData.pavementName,
        pavementNameAm:rowData.pavementNameAm,
        pavementNameOr:rowData.pavementNameOr,
        pavementNameTi:rowData.pavementNameTi,
        pavementNameAf:rowData.pavementNameAf,
        pavementNameSo:rowData.pavementNameSo,
